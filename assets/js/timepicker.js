        ...
        , setDefaultTime: function(defaultTime){
            if (defaultTime) {
                if (defaultTime === 'current') {
                    ...
                    var minutes = Math.floor(dTime.getMinutes() / this.minuteStep) *
this.minuteStep;
        ...
        , updateWidget: function() {
            this.$widget
                ...
                .find('td.bootstrap-timepicker-minute').text(this.minute < 10 ? '0' +
this.minute : this.minute).end()
...
class="icon-chevron-down"></i></a></td>'+
                    ...
                    '</table>'+
            '</div>'
    , modalTemplate: '<div class="bootstrap-timepicker modal hide fade in" style="top:
30%; margin-top: 0; width: 200px; margin-left: -100px;" data-backdrop="false">'+
...
class="icon-chevron-down"></i></a></td>'+
    ...
    $(function () {
        $('body').on('focus.timepicker.data-api', '[data-provide="timepicker"]', function
(e) {
            var $this = $(this);
