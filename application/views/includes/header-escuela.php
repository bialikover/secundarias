						...
						<div class="row-fluid"> 
							<div id="my-menu" class="span12">
								...
								<ul class="nav pull-right">
									...
									<li><a class="my-a"  href="<?php echo base_url("administracion/docentes/index")?>">  
									...
									<li><a  href="<?php echo base_url("administracion/materias/index")?>"> 
									...
									<li><a  href="<?php echo base_url("administracion/grupos/index")?>"> 
									...
									<li><a  href="<?php echo base_url("actividad/crear")?>"> 
